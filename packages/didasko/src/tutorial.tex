...
\documentclass[11pt,letter,relax]{SANDreport}
\usepackage{graphicx}
...
\author{Marzio Sala, Michael Heroux, David Day, Christopher Baker, Heidi Thornquist \\
...
\title{Trilinos Tutorial\footnote{Compatible with Trilinos Release 6.0.X}}
\SANDnum{SAND2004-2189}
\SANDauthor{
Marzio Sala, Michael Heroux, David Day, Christopher Baker, Heidi Thornquist}

\SANDprintDate{September 2005}
...
\begin{abstract}
  ...
  This document introduces the use of \Trilinos{}, Release 6.0 and subsequent minor
  releases 6.0.X.  The
