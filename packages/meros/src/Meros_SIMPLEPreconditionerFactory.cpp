...
{
  TEUCHOS_TEST_FOR_EXCEPT("SIMPLEPreconditionerFactory::isCompatible is not implemented");
}
...
{
TEUCHOS_TEST_FOR_EXCEPT("SIMPLEPreconditionerFactory::uninitializePrec not implemented");
}
