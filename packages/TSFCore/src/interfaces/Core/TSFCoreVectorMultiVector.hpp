...
// /////////////////////////////////////////////////////////////////
// TSFCoreVectorMultiVector.hpp

#ifndef TSFCORE_VECTOR_MULTI_VECTOR_HPP
#define TSFCORE_VECTOR_MULTI_VECTOR_HPP

// Define to make some verbose output
//#define TSFCORE_VECTOR_MULTI_VECTOR_VERBOSE_TO_ERROR_OUT

#include "TSFCoreVectorMultiVectorDecl.hpp"
...
// Overridden from LinearOp (forwarded to this->mv())
...
// Overridden from MultiVector (forwarded to this->mv())
...
{
#ifdef TSFCORE_VECTOR_MULTI_VECTOR_VERBOSE_TO_ERROR_OUT
  ...
  ) const
{
  ...
  // Get MultiVector arguments
	Workspace<const MultiVector<Scalar>*> multi_vecs(wss,num_vecs,false);
  for( int k = 0; k < num_vecs; ++k ) {
	...
	Workspace<MultiVector<Scalar>*> targ_multi_vecs(wss,num_targ_vecs,false);
...
#endif // TSFCORE_VECTOR_MULTI_VECTOR_HPP
