...
#ifndef TSFCORE_SERIAL_MULTI_VECTOR_BASE_DECL_HPP
#define TSFCORE_SERIAL_MULTI_VECTOR_BASE_DECL_HPP
 ...
 * direct access to MultiVector data: <<tt>getData(const
...
public:
	...
	///
	/** Free view of local data that was gotten from <tt>getData()</tt>.
	 *
	...
	///
	/** Commit view of local data that was gotten from <tt>getData()</tt>.
	 *
	 * @param  values      [in/out] On input <tt>*values</tt> must be the pointer set
	 *                     by <tt>getData()</tt>.
	 */
...
protected:
	...
	///
	/** Subclasses should call whenever the structure of any
	 * <tt>VectorSpace</tt> changes.
	 *
...
#endif // TSFCORE_SERIAL_MULTI_VECTOR_BASE_DECL_HPP
