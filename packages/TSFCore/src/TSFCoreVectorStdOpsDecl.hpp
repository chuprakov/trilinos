 ...
 * elements.
 * 
 * The elements <tt>y(i)</tt> are randomly generated between
 * <tt>[l,u]</tt>.
 *
 * The seed is set using <tt>seed_random_vector_generator()</tt>
 */
template<class Scalar>
void random_vector( Scalar l, Scalar u, Vector<Scalar>* v );
