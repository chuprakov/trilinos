...
// //////////////////////////////////////////////////////////////
// TSFCoreProductVectorBase.hpp

#ifndef TSFCORE_PRODUCT_VECTOR_BASE_HPP
#define TSFCORE_PRODUCT_VECTOR_BASE_HPP
...
public:
	 ...
	 */
	virtual Teuchos::RefCountPtr<Vector<Scalar> > getBlock(const int k) = 0; 
	 ...
	 * </ul>
	 */
	virtual Teuchos::RefCountPtr<const Vector<Scalar> > getBlock(const int k) const = 0; 

};

} // namespace TSFCore

#endif // TSFCORE_PRODUCT_VECTOR_BASE_HPP
