...
// //////////////////////////////////////////////////////////////
// TSFCoreProductVectorSpaceBase.hpp

#ifndef TSFCORE_PRODUCT_VECTOR_SPACE_BASE_HPP
#define TSFCORE_PRODUCT_VECTOR_SPACE_BASE_HPP
 ...
 * inherited from the <tt>VectorSpace</tt> interface) must support the
...
class ProductVectorSpaceBase : virtual public VectorSpace<Scalar> {
public:
	...
	///
	/** Returns a vector space for the <tt>kth</tt> (zero-based) block.
	 *
	 * Preconditions:<ul>
	 * <li> <tt>0 <= k <= numBlocks()-1</tt>
	 * </ul>
	 */
	virtual Teuchos::RefCountPtr<const VectorSpace<Scalar> > getBlock(const int k) const = 0; 

#ifdef DOXYGEN_COMPILE
private:
	const VectorSpace<Scalar> *spaces;
#endif
...
#endif // TSFCORE_PRODUCT_VECTOR_SPACE_BASE_HPP
