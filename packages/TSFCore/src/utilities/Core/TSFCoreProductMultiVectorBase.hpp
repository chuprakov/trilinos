...
// //////////////////////////////////////////////////////////////
// TSFCoreProductMultiVectorBase.hpp

#ifndef TSFCORE_PRODUCT_MULTI_VECTOR_HPP
#define TSFCORE_PRODUCT_MULTI_VECTOR_HPP
...
public:
	...
	///
	/** Returns a transitive non-<tt>const</tt> view of the (zero-based)
	 ...
	 */
	virtual Teuchos::RefCountPtr<MultiVector<Scalar> > getBlock(const int k) = 0;

	///
	/** Returns a transitive <tt>const</tt> view of the (zero-based)
	 ...
	 * </ul>
	 */
	virtual Teuchos::RefCountPtr<const MultiVector<Scalar> > getBlock(const int k) const = 0;

};

} // namespace TSFCore

#endif // TSFCORE_PRODUCT_MULTI_VECTOR_HPP
