...
#ifndef TSFCORE_GET_EPETRA_OPERATOR_HPP
#define TSFCORE_GET_EPETRA_OPERATOR_HPP
...
get_Epetra_Operator( const LinearOp<double> &op );

} // namespace TSFCore

#endif // TSFCORE_GET_EPETRA_OPERATOR_HPP
