 ...
 * have unit stride to simplify thing.  However, if you subclass can
...
protected:
	 ...
	 *
	 * See <tt>LinearOp::euclideanApply()</tt> for a discussion of the arguments
	 * to this function. what this function means.  What differentiates this function
	 * is that <tt>x</tt> and <tt>y</tt> are passed as objects with explicit pointers
	 * to vector data.
	 *
	 ...
	 *
	 * See <tt>LinearOp::euclideanApply()</tt> for a discussion of the arguments
	 * to this function. what this function means.  What differentiates
	 * this function is that <tt>X</tt> and <tt>Y</tt> are passed as
	 * objects with explicit pointers to multi-vector data.
	 *
	 * Since this function is protected and does not get directly called by a client.
